...
public class Project implements Comparable { //Implements comparable to compare project start start dates
    ...
    private LocalDate startDate, endDate; //Stores start and end date of the project

    public Project(String projectName, String customer, Address projectAdress, LocalDate startDate, LocalDate endDate) {
    ...
    public Project(String projectName, String customer, Address projectAddress) { //Overloaded constructor since not every project has a start and end date.
